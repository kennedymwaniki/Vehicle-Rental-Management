...
export const getTicketById = async (id: number): Promise<TSCustomerSupportTicket | undefined> => {
...
export const updateTicketService = async (id: number, ticket: TICustomerSupportTicket) => {
